...
const T = function () {
    ...
    function a(t) {
        ...
        t.referrerpolicy && (o.referrerPolicy = t.referrerpolicy),
            t.crossorigin === "use-credentials" ? o.credentials = "include" :
                t.crossorigin === "anonymous" ? o.credentials = "omit" :
...
function A(g) {
    ...
    let r;
    const h = () => { a || r.slideNext() };
    const p = () => { a || r.slidePrev() };
    ...
    return r = new F(m, {
        ...
        allowTouchMove: !1,
        parallax: !0,
        loop: !0, // ✅ Ajout du mode boucle infinie
        autoplay: {
            delay: 2000, // ✅ Changement automatique toutes les 3 secondes
            disableOnInteraction: !1 // Continue même si l’utilisateur clique
        },
        on: {
            loopFix() { y = !1 },
            transitionStart(e) {
            ...
            transitionEnd(e) {
                ...
                v || (
                    n === 0 ? s.querySelector(".fashion-slider-button-prev").classList.add("fashion-slider-button-disabled") :
                        s.querySelector(".fashion-slider-button-prev").classList.remove("fashion-slider-button-disabled"),
                        n === c.length - 1 ? s.querySelector(".fashion-slider-button-next").classList.add("fashion-slider-button-disabled") :
