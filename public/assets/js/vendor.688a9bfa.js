...
var ae = (i, e, t) => e in i ? be(i, e, {enumerable: !0, configurable: !0, writable: !0, value: t}) : i[e] = t,
    W = (i, e) => {
    ...
    for (let t = 1; t < arguments.length; t += 1) {
        ...
        if (s != null && !Oe(s)) {
            ...
            for (let r = 0, l = n.length; r < l; r += 1) {
                ...
                a !== void 0 && a.enumerable && ($(i[o]) && $(s[o]) ? s[o].__swiper__ ? i[o] = s[o] : A(i[o], s[o]) : !$(i[o]) && $(s[o]) ? (i[o] = {}, s[o].__swiper__ ? i[o] = s[o] : A(i[o], s[o])) : i[o] = s[o])
            }
        }
    }
    return i
...
function de(i) {
    ...
    const n = z(), r = -e.translate;
    let l = null, o;
    const a = e.params.speed;
    e.wrapperEl.style.scrollSnapType = "none", n.cancelAnimationFrame(e.cssModeFrameID);
    const d = t > r ? "next" : "prev", c = (p, f) => d === "next" && p >= f || d === "prev" && p <= f, u = () => {
        o = new Date().getTime(), l === null && (l = o);
        const p = Math.max(Math.min((o - l) / a, 1), 0), f = .5 - Math.cos(p * Math.PI) / 2;
        let m = r + f * (t - r);
...
function Fe(i) {
    ...
    const t = ue(), s = z(), n = s.navigator.platform, r = e || s.navigator.userAgent, l = {ios: !1, android: !1},
        o = s.screen.width, a = s.screen.height, d = r.match(/(Android);?[\s\/]+([\d.]+)?/);
    let c = r.match(/(iPad).*OS\s([\d_]+)/);
    const u = r.match(/(iPod)(.*OS\s([\d_]+))?/), p = !c && r.match(/(iPhone\sOS|iOS)\s([\d_]+)/), f = n === "Win32";
    let m = n === "MacIntel";
    const w = ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"];
    return !c && m && t.touch && w.indexOf(`${o}x${a}`) >= 0 && (c = r.match(/(Version)\/([\d.]+)/), c || (c = [0, 1, "13_0_0"]), m = !1), d && !f && (l.os = "android", l.android = !0), (c || p || u) && (l.os = "ios", l.ios = !0), l
}
        ...
        !e || e.destroyed || !e.initialized || (r = new ResizeObserver(u => {
            l = n.requestAnimationFrame(() => {
                ...
                u.forEach(T => {
                    ...
                    g && g !== e.el || (m = x ? x.width : (h[0] || h).inlineSize, w = x ? x.height : (h[0] || h).blockSize)
                }), (m !== p || w !== f) && o()
            })
        }), r.observe(e.el))
    }, d = () => {
...
function Re(i) {
    ...
    const r = [], l = z(), o = function (c, u) {
        u === void 0 && (u = {});
        const p = l.MutationObserver || l.WebkitMutationObserver, f = new p(m => {
    ...
    t({observer: !1, observeParents: !1, observeSlideChildren: !1}), s("init", a), s("destroy", d)
}
...
function je() {
    ...
    const t = i.params, {wrapperEl: s, slidesEl: n, size: r, rtlTranslate: l, wrongRTL: o} = i,
        a = i.virtual && t.virtual.enabled, d = a ? i.virtual.slides.length : i.slides.length,
        c = O(n, `.${i.params.slideClass}, swiper-slide`), u = a ? i.virtual.slides.length : c.length;
    let p = [];
    const f = [], m = [];
    ...
    const h = i.snapGrid.length, x = i.slidesGrid.length;
    let g = t.spaceBetween, v = -w, P = 0, M = 0;
    if (typeof r == "undefined") return;
    typeof g == "string" && g.indexOf("%") >= 0 ? g = parseFloat(g.replace("%", "")) / 100 * r : typeof g == "string" && (g = parseFloat(g)), i.virtualSize = -g, c.forEach(S => {
    ...
    for (let S = 0; S < u; S += 1) {
        I = 0;
        let y;
        if (c[S] && (y = c[S]), V && i.grid.updateSlide(S, y, c), !(c[S] && D(y, "display") === "none")) {
            if (t.slidesPerView === "auto") {
                F && (c[S].style[i.getDirectionLabel("width")] = "");
                const E = getComputedStyle(y), b = y.style.transform, C = y.style.webkitTransform;
                if (b && (y.style.transform = "none"), C && (y.style.webkitTransform = "none"), t.roundLengths) I = i.isHorizontal() ? fe(y, "width", !0) : fe(y, "height", !0); else {
                    const L = e(E, "width"), k = e(E, "padding-left"), Se = e(E, "padding-right"),
                        ie = e(E, "margin-left"), se = e(E, "margin-right"), re = E.getPropertyValue("box-sizing");
                    if (re && re === "border-box") I = L + ie + se; else {
                        const {clientWidth: Te, offsetWidth: xe} = y;
                        I = L + k + Se + ie + se + (xe - Te)
                    }
                }
                b && (y.style.transform = b), C && (y.style.webkitTransform = C), t.roundLengths && (I = Math.floor(I))
            } else I = (r - (t.slidesPerView - 1) * g) / t.slidesPerView, t.roundLengths && (I = Math.floor(I)), c[S] && (c[S].style[i.getDirectionLabel("width")] = `${I}px`);
            c[S] && (c[S].swiperSlideSize = I), m.push(I), t.centeredSlides ? (v = v + I / 2 + P / 2 + g, P === 0 && S !== 0 && (v = v - r / 2 - g), S === 0 && (v = v - r / 2 - g), Math.abs(v) < 1 / 1e3 && (v = 0), t.roundLengths && (v = Math.floor(v)), M % t.slidesPerGroup == 0 && p.push(v), f.push(v)) : (t.roundLengths && (v = Math.floor(v)), (M - Math.min(i.params.slidesPerGroupSkip, M)) % i.params.slidesPerGroup == 0 && p.push(v), f.push(v), v = v + I + g), i.virtualSize += I + g, P = I, M += 1
        }
    }
    if (i.virtualSize = Math.max(i.virtualSize, r) + T, l && o && (t.effect === "slide" || t.effect === "coverflow") && (s.style.width = `${i.virtualSize + g}px`), t.setWrapperSize && (s.style[i.getDirectionLabel("width")] = `${i.virtualSize + g}px`), V && i.grid.updateWrapperSize(I, p), !t.centeredSlides) {
        const S = [];
        for (let y = 0; y < p.length; y += 1) {
            let E = p[y];
            t.roundLengths && (E = Math.floor(E)), p[y] <= i.virtualSize - r && S.push(E)
        }
    ...
    if (a && t.loop) {
        ...
        for (let y = 0; y < i.virtual.slidesBefore + i.virtual.slidesAfter; y += 1) t.slidesPerGroup === 1 && p.push(p[p.length - 1] + S), f.push(f[f.length - 1] + S), i.virtualSize += S
    }
    ...
    if (Object.assign(i, {
        ...
        _(s, "--swiper-centered-offset-before", `${-p[0]}px`), _(s, "--swiper-centered-offset-after", `${i.size / 2 - m[m.length - 1] / 2}px`);
        const S = -i.snapGrid[0], y = -i.slidesGrid[0];
        i.snapGrid = i.snapGrid.map(E => E + S), i.slidesGrid = i.slidesGrid.map(E => E + y)
    }
    if (u !== d && i.emit("slidesLengthChange"), p.length !== h && (i.params.watchOverflow && i.checkOverflow(), i.emit("snapGridLengthChange")), f.length !== x && i.emit("slidesGridLengthChange"), t.watchSlidesProgress && i.updateSlidesOffset(), !a && !t.cssMode && (t.effect === "slide" || t.effect === "fade")) {
        const S = `${t.containerModifierClass}backface-hidden`, y = i.el.classList.contains(S);
...
function Ye(i) {
    ...
    if (e.params.slidesPerView !== "auto" && e.params.slidesPerView > 1) if (e.params.centeredSlides) (e.visibleSlides || []).forEach(o => {
        t.push(o)
    ...
    for (r = 0; r < t.length; r += 1) if (typeof t[r] != "undefined") {
...
function Xe(i) {
    ...
    const e = this, t = e.params, {slides: s, rtlTranslate: n, snapGrid: r} = e;
    ...
    for (let a = 0; a < s.length; a += 1) {
        ...
        const u = (l + (t.centeredSlides ? e.minTranslate() : 0) - c) / (d.swiperSlideSize + o),
            p = (l - r[0] + (t.centeredSlides ? e.minTranslate() : 0) - c) / (d.swiperSlideSize + o), f = -(l - c),
            m = f + e.slidesSizesGrid[a], w = f >= 0 && f <= e.size - e.slidesSizesGrid[a];
        (f >= 0 && f < e.size - 1 || m > 1 && m <= e.size || f <= 0 && m >= e.size) && (e.visibleSlides.push(d), e.visibleSlidesIndexes.push(a), s[a].classList.add(t.slideVisibleClass)), w && s[a].classList.add(t.slideFullyVisibleClass), d.progress = n ? -u : u, d.originalProgress = n ? -p : p
    }
}
...
function Ke(i) {
    ...
    const a = r, d = l;
    if (s === 0) n = 0, r = !0, l = !0; else {
        n = (i - e.minTranslate()) / s;
        const c = Math.abs(i - e.minTranslate()) < 1, u = Math.abs(i - e.maxTranslate()) < 1;
        r = c || n <= 0, l = u || n >= 1, c && (n = 0), u && (n = 1)
    }
    if (t.loop) {
        const c = e.getSlideIndexByData(0), u = e.getSlideIndexByData(e.slides.length - 1), p = e.slidesGrid[c],
            f = e.slidesGrid[u], m = e.slidesGrid[e.slidesGrid.length - 1], w = Math.abs(i);
    ...
    Object.assign(e, {
        ...
        isBeginning: r,
        isEnd: l
    }), (t.watchSlidesProgress || t.centeredSlides && t.autoHeight) && e.updateSlidesProgress(i), r && !a && e.emit("reachBeginning toEdge"), l && !d && e.emit("reachEnd toEdge"), (a && !r || d && !l) && e.emit("fromEdge"), e.emit("progress", n)
}

function Ue() {
    const i = this, {slides: e, params: t, slidesEl: s, activeIndex: n} = i, r = i.virtual && t.virtual.enabled,
        l = i.grid && t.grid && t.grid.rows > 1, o = u => O(s, `.${t.slideClass}${u}, swiper-slide${u}`)[0];
    e.forEach(u => {
    ...
    } else a = o(`[data-swiper-slide-index="${n}"]`); else l ? (a = e.filter(u => u.column === n)[0], c = e.filter(u => u.column === n + 1)[0], d = e.filter(u => u.column === n - 1)[0]) : a = e[n];
    a && (a.classList.add(t.slideActiveClass), l ? (c && c.classList.add(t.slideNextClass), d && d.classList.add(t.slidePrevClass)) : (c = ke(a, `.${t.slideClass}, swiper-slide`)[0], t.loop && !c && (c = e[0]), c && c.classList.add(t.slideNextClass), d = Ge(a, `.${t.slideClass}, swiper-slide`)[0], t.loop && !d === 0 && (d = e[e.length - 1]), d && d.classList.add(t.slidePrevClass))), i.emitSlidesClasses()
}
...
const H = (i, e) => {
    ...
    if (i.params.grid && i.params.grid.rows > 1) {
        const l = n, o = [l - e];
        o.push(...Array.from({length: e}).map((a, d) => l + s + d)), i.slides.forEach((a, d) => {
            o.includes(a.column) && Q(i, d)
        });
        return
    }
    const r = n + s - 1;
    if (i.params.rewind || i.params.loop) for (let l = n - e; l <= r + e; l += 1) {
        const o = (l % t + t) % t;
        (o < n || o > r) && Q(i, o)
    } else for (let l = Math.max(n - e, 0); l <= Math.min(r + e, t - 1); l += 1) l !== n && (l > r || l < n) && Q(i, l)
};
...
function Qe(i) {
    ...
    if (typeof a == "undefined" && (a = Je(e)), s.indexOf(t) >= 0) d = s.indexOf(t); else {
    ...
    let p;
    if (e.virtual && n.virtual.enabled && n.loop) p = c(a); else if (u) {
        const f = e.slides.filter(w => w.column === a)[0];
        let m = parseInt(f.getAttribute("data-swiper-slide-index"), 10);
        Number.isNaN(m) && (m = Math.max(e.slides.indexOf(f), 0)), p = Math.floor(m / n.grid.rows)
    } else if (e.slides[a]) {
...
function Ze(i, e) {
    ...
    if (n && r) t.clickedSlide = n, t.virtual && t.params.virtual.enabled ? t.clickedIndex = parseInt(n.getAttribute("data-swiper-slide-index"), 10) : t.clickedIndex = l; else {
...
function tt(i) {
    ...
    const e = this, {params: t, rtlTranslate: s, translate: n, wrapperEl: r} = e;
...
function it(i, e) {
    const t = this, {rtlTranslate: s, params: n, wrapperEl: r, progress: l} = t;
    let o = 0, a = 0;
    const d = 0;
    ...
    u === 0 ? c = 0 : c = (i - t.minTranslate()) / u, c !== l && t.updateProgress(i), t.emit("setTranslate", t.translate, e)
}
...
function nt(i, e, t, s, n) {
    ...
    const r = this, {params: l, wrapperEl: o} = r;
    ...
    if (s && i > a ? c = a : s && i < d ? c = d : c = i, r.updateProgress(c), l.cssMode) {
        ...
        if (e === 0) o[u ? "scrollLeft" : "scrollTop"] = -c; else {
            if (!r.support.smoothScroll) return de({swiper: r, targetPosition: -c, side: u ? "left" : "top"}), !0;
            o.scrollTo({[u ? "left" : "top"]: -c, behavior: "smooth"})
        }
        return !0
    }
    return e === 0 ? (r.setTransition(0), r.setTranslate(c), t && (r.emit("beforeTransitionStart", e, n), r.emit("transitionEnd"))) : (r.setTransition(e), r.setTranslate(c), t && (r.emit("beforeTransitionStart", e, n), r.emit("transitionStart")), r.animating || (r.animating = !0, r.onTranslateToWrapperTransitionEnd || (r.onTranslateToWrapperTransitionEnd = function (p) {
        !r || r.destroyed || p.target === this && (r.wrapperEl.removeEventListener("transitionend", r.onTranslateToWrapperTransitionEnd), r.onTranslateToWrapperTransitionEnd = null, delete r.onTranslateToWrapperTransitionEnd, t && r.emit("transitionEnd"))
    }), r.wrapperEl.addEventListener("transitionend", r.onTranslateToWrapperTransitionEnd))), !0
}

var at = {getTranslate: tt, setTranslate: it, minTranslate: st, maxTranslate: rt, translateTo: nt};
...
function ot(i, e) {
    ...
    s.cssMode || (s.autoHeight && t.updateAutoHeight(), pe({swiper: t, runCallbacks: i, direction: e, step: "Start"}))
}

function dt(i, e) {
    i === void 0 && (i = !0);
    const t = this, {params: s} = t;
    t.animating = !1, !s.cssMode && (t.setTransition(0), pe({swiper: t, runCallbacks: i, direction: e, step: "End"}))
}
...
function ft(i, e, t, s, n) {
    ...
    const h = -a[T];
    if (o.normalizeSlideIndex) for (let g = 0; g < d.length; g += 1) {
        const v = -Math.floor(h * 100), P = Math.floor(d[g] * 100), M = Math.floor(d[g + 1] * 100);
        typeof d[g + 1] != "undefined" ? v >= P && v < M - (M - P) / 2 ? l = g : v >= P && v < M && (l = g + 1) : v >= P && (l = g)
    }
    if (r.initialized && l !== u && (!r.allowSlideNext && (p ? h > r.translate && h > r.minTranslate() : h < r.translate && h < r.minTranslate()) || !r.allowSlidePrev && h > r.translate && h > r.maxTranslate() && (u || 0) !== l)) return !1;
    l !== (c || 0) && t && r.emit("beforeSlideChangeStart"), r.updateProgress(h);
    let x;
    if (l > u ? x = "next" : l < u ? x = "prev" : x = "reset", p && -h === r.translate || !p && h === r.translate) return r.updateActiveIndex(l), o.autoHeight && r.updateAutoHeight(), r.updateSlidesClasses(), o.effect !== "slide" && r.setTranslate(h), x !== "reset" && (r.transitionStart(t, x), r.transitionEnd(t, x)), !1;
    if (o.cssMode) {
        const g = r.isHorizontal(), v = p ? h : -h;
        if (e === 0) {
            ...
            })) : f[g ? "scrollLeft" : "scrollTop"] = v, P && requestAnimationFrame(() => {
                r.wrapperEl.style.scrollSnapType = "", r._immediateVirtual = !1
            })
        } else {
            if (!r.support.smoothScroll) return de({swiper: r, targetPosition: v, side: g ? "left" : "top"}), !0;
            f.scrollTo({[g ? "left" : "top"]: v, behavior: "smooth"})
        }
        return !0
    }
    return r.setTransition(e), r.setTranslate(h), r.updateActiveIndex(l), r.updateSlidesClasses(), r.emit("beforeTransitionStart", e, s), r.transitionStart(t, x), e === 0 ? r.transitionEnd(t, x) : r.animating || (r.animating = !0, r.onSlideToWrapperTransitionEnd || (r.onSlideToWrapperTransitionEnd = function (v) {
        !r || r.destroyed || v.target === this && (r.wrapperEl.removeEventListener("transitionend", r.onSlideToWrapperTransitionEnd), r.onSlideToWrapperTransitionEnd = null, delete r.onSlideToWrapperTransitionEnd, r.transitionEnd(t, x))
...
function ut(i, e, t, s) {
    ...
    let l = i;
    if (n.params.loop) if (n.virtual && n.params.virtual.enabled) l = l + n.virtual.slidesBefore; else {
        let o;
        if (r) {
        ...
        const a = r ? Math.ceil(n.slides.length / n.params.grid.rows) : n.slides.length, {centeredSlides: d} = n.params;
...
function mt(i, e, t) {
    i === void 0 && (i = this.params.speed), e === void 0 && (e = !0);
    const s = this, {params: n, snapGrid: r, slidesGrid: l, rtlTranslate: o, enabled: a, animating: d} = s;
    if (!a) return s;
    ...
    let T = 0;
    if (typeof w != "undefined" && (T = l.indexOf(w), T < 0 && (T = s.activeIndex - 1), n.slidesPerView === "auto" && n.slidesPerGroup === 1 && n.slidesPerGroupAuto && (T = T - s.slidesPerViewDynamic("previous", !0) + 1, T = Math.max(T, 0))), n.rewind && s.isBeginning) {
...
function gt(i, e, t, s) {
    ...
    const n = this;
    let r = n.activeIndex;
    const l = Math.min(n.params.slidesPerGroupSkip, r), o = l + Math.floor((r - l) / n.params.slidesPerGroup),
...
function vt() {
    ...
    if (e.loop) {
        ...
        r = parseInt(i.clickedSlide.getAttribute("data-swiper-slide-index"), 10), e.centeredSlides ? n < i.loopedSlides - s / 2 || n > i.slides.length - i.loopedSlides + s / 2 ? (i.loopFix(), n = i.getSlideIndex(O(t, `${l}[data-swiper-slide-index="${r}"]`)[0]), q(() => {
            i.slideTo(n)
        })) : i.slideTo(n) : n > i.slides.length - s ? (i.loopFix(), n = i.getSlideIndex(O(t, `${l}[data-swiper-slide-index="${r}"]`)[0]), q(() => {
            i.slideTo(n)
        })) : i.slideTo(n)
    } else i.slideTo(n)
}
...
function St(i) {
    ...
    const n = () => {
        ...
        }, r = e.grid && t.grid && t.grid.rows > 1, l = t.slidesPerGroup * (r ? t.grid.rows : 1),
        o = e.slides.length % l != 0, a = r && e.slides.length % t.grid.rows != 0, d = c => {
            for (let u = 0; u < c; u += 1) {
...
function Tt(i) {
    ...
    const {slides: d, allowSlidePrev: c, allowSlideNext: u, slidesEl: p, params: f} = a, {centeredSlides: m} = f;
    ...
    w === "auto" ? w = a.slidesPerViewDynamic() : (w = Math.ceil(parseFloat(f.slidesPerView, 10)), m && w % 2 == 0 && (w = w + 1));
    const T = f.slidesPerGroupAuto ? w : f.slidesPerGroup;
    let h = T;
    h % T != 0 && (h += T - h % T), h += f.loopAdditionalSlides, a.loopedSlides = h;
    ...
    if (E < h) {
        ...
        for (let b = 0; b < h - E; b += 1) {
            ...
            if (x) {
                const L = S - C - 1;
                for (let k = d.length - 1; k >= 0; k -= 1) d[k].column === L && g.push(k)
            } else g.push(S - C - 1)
        }
    } else if (E + w > S - h) {
    ...
    }), a.recalcSlides(), f.slidesPerView === "auto" ? a.updateSlides() : x && (g.length > 0 && V || v.length > 0 && M) && a.slides.forEach((b, C) => {
        a.grid.updateSlide(C, b, a.slides)
    }), f.watchSlidesProgress && a.updateSlidesOffset(), t) {
        if (g.length > 0 && V) {
            if (typeof e == "undefined") {
                const b = a.slidesGrid[P], L = a.slidesGrid[P + I] - b;
                o ? a.setTranslate(a.translate - L) : (a.slideTo(P + I, 0, !1, !0), n && (a.touchEventsData.startTranslate = a.touchEventsData.startTranslate - L, a.touchEventsData.currentTranslate = a.touchEventsData.currentTranslate - L))
            } else if (n) {
                const b = x ? g.length / f.grid.rows : g.length;
                a.slideTo(a.activeIndex + b, 0, !1, !0), a.touchEventsData.currentTranslate = a.translate
            }
        } else if (v.length > 0 && M) if (typeof e == "undefined") {
            const b = a.slidesGrid[P], L = a.slidesGrid[P - F] - b;
            o ? a.setTranslate(a.translate - L) : (a.slideTo(P - F, 0, !1, !0), n && (a.touchEventsData.startTranslate = a.touchEventsData.startTranslate - L, a.touchEventsData.currentTranslate = a.touchEventsData.currentTranslate - L))
        } else {
            const b = x ? v.length / f.grid.rows : v.length;
            a.slideTo(a.activeIndex - b, 0, !1, !0)
        }
    }
    if (a.allowSlidePrev = c, a.allowSlideNext = u, a.controller && a.controller.control && !l) {
        const b = {slideRealIndex: e, direction: s, setTranslate: n, activeSlideIndex: r, byController: !0};
        Array.isArray(a.controller.control) ? a.controller.control.forEach(C => {
            !C.destroyed && C.params.loop && C.loopFix(j(W({}, b), {slideTo: C.params.slidesPerView === f.slidesPerView ? t : !1}))
        }) : a.controller.control instanceof a.constructor && a.controller.control.params.loop && a.controller.control.loopFix(j(W({}, b), {slideTo: a.controller.control.params.slidesPerView === f.slidesPerView ? t : !1}))
    }
    a.emit("loopFix")
}
...
function me(i, e, t) {
    const s = z(), {params: n} = i, r = n.edgeSwipeDetection, l = n.edgeSwipeThreshold;
...
function It(i) {
    ...
    const f = l.currentX, m = l.currentY;
    if (!me(e, s, f)) return;
    Object.assign(n, {
        isTouched: !0,
        isMoved: !1,
        ...
        isScrolling: void 0,
        startMoving: void 0
    }), l.startX = f, l.startY = m, n.touchStartTime = N(), e.allowClick = !0, e.updateSize(), e.swipeDirection = void 0, r.threshold > 0 && (n.allowThresholdMove = !1);
    let w = !0;
...
function Ct(i) {
    const e = B(), t = this, s = t.touchEventsData, {params: n, touches: r, rtlTranslate: l, enabled: o} = t;
    ...
    s.allowTouchCallbacks && t.emit("touchMove", a), r.previousX = r.currentX, r.previousY = r.currentY, r.currentX = c, r.currentY = u;
    ...
    let m = t.isHorizontal() ? p : f, w = t.isHorizontal() ? r.currentX - r.previousX : r.currentY - r.previousY;
    ...
    if (!s.isMoved) {
        if (h && x && t.loopFix({direction: t.swipeDirection}), s.startTranslate = t.getTranslate(), t.setTransition(0), t.animating) {
            const M = new window.CustomEvent("transitionend", {bubbles: !0, cancelable: !0});
    ...
    let g;
    if (new Date().getTime(), s.isMoved && s.allowThresholdMove && T !== t.touchesDirection && h && x && Math.abs(m) >= 1) {
        Object.assign(r, {
            startX: c,
            startY: u,
            currentX: c,
    ...
    let v = !0, P = n.resistanceRatio;
    if (n.touchReleaseOnEdges && (P = 0), m > 0 ? (h && x && !g && s.allowThresholdMove && s.currentTranslate > (n.centeredSlides ? t.minTranslate() - t.slidesSizesGrid[t.activeIndex + 1] : t.minTranslate()) && t.loopFix({
        direction: "prev",
        setTranslate: !0,
        activeSlideIndex: 0
    }), s.currentTranslate > t.minTranslate() && (v = !1, n.resistance && (s.currentTranslate = t.minTranslate() - 1 + (-t.minTranslate() + s.startTranslate + m) ** P))) : m < 0 && (h && x && !g && s.allowThresholdMove && s.currentTranslate < (n.centeredSlides ? t.maxTranslate() + t.slidesSizesGrid[t.slidesSizesGrid.length - 1] : t.maxTranslate()) && t.loopFix({
        direction: "next",
        setTranslate: !0,
        activeSlideIndex: t.slides.length - (n.slidesPerView === "auto" ? t.slidesPerViewDynamic() : Math.ceil(parseFloat(n.slidesPerView, 10)))
    }), s.currentTranslate < t.maxTranslate() && (v = !1, n.resistance && (s.currentTranslate = t.maxTranslate() + 1 - (t.maxTranslate() - s.startTranslate - m) ** P))), v && (a.preventedByNestedSwiper = !0), !t.allowSlideNext && t.swipeDirection === "next" && s.currentTranslate < s.startTranslate && (s.currentTranslate = s.startTranslate), !t.allowSlidePrev && t.swipeDirection === "prev" && s.currentTranslate > s.startTranslate && (s.currentTranslate = s.startTranslate), !t.allowSlidePrev && !t.allowSlideNext && (s.currentTranslate = s.startTranslate), n.threshold > 0) if (Math.abs(m) > n.threshold || s.allowThresholdMove) {
...
function Lt(i) {
    ...
    if (s.type === "touchend" || s.type === "touchcancel") {
        if (n = [...s.changedTouches].filter(v => v.identifier === t.touchId)[0], !n || n.identifier !== t.touchId) return
    } else {
    ...
    const u = N(), p = u - t.touchStartTime;
    if (e.allowClick) {
        const v = s.path || s.composedPath && s.composedPath();
        e.updateClickedSlide(v && v[0] || s.target, v), e.emit("tap click", s), p < 300 && u - t.lastClickTime < 300 && e.emit("doubleTap doubleClick", s)
    }
    if (t.lastClickTime = N(), q(() => {
    ...
    t.isTouched = !1, t.isMoved = !1, t.startMoving = !1;
    let f;
    if (l.followFinger ? f = a ? e.translate : -e.translate : f = -t.currentTranslate, l.cssMode) return;
    ...
    for (let v = 0; v < d.length; v += v < l.slidesPerGroupSkip ? 1 : l.slidesPerGroup) {
        ...
        typeof d[v + P] != "undefined" ? f >= d[v] && f < d[v + P] && (m = v, w = d[v + P] - d[v]) : f >= d[v] && (m = v, w = d[d.length - 1] - d[d.length - 2])
    }
    let T = null, h = null;
    l.rewind && (e.isBeginning ? h = l.virtual && l.virtual.enabled && e.virtual ? e.virtual.slides.length - 1 : e.slides.length - 1 : e.isEnd && (T = 0));
    const x = (f - d[m]) / w, g = m < l.slidesPerGroupSkip - 1 ? 1 : l.slidesPerGroup;
    if (p > l.longSwipesMs) {
        if (!l.longSwipes) {
            e.slideTo(e.activeIndex);
            return
        }
        e.swipeDirection === "next" && (x >= l.longSwipesRatio ? e.slideTo(l.rewind && e.isEnd ? T : m + g) : e.slideTo(m)), e.swipeDirection === "prev" && (x > 1 - l.longSwipesRatio ? e.slideTo(m + g) : h !== null && x < 0 && Math.abs(x) > l.longSwipesRatio ? e.slideTo(h) : e.slideTo(m))
    } else {
        if (!l.shortSwipes) {
            e.slideTo(e.activeIndex);
            return
        }
        e.navigation && (s.target === e.navigation.nextEl || s.target === e.navigation.prevEl) ? s.target === e.navigation.nextEl ? e.slideTo(m + g) : e.slideTo(m) : (e.swipeDirection === "next" && e.slideTo(T !== null ? T : m + g), e.swipeDirection === "prev" && e.slideTo(h !== null ? h : m))
    }
}
...
function he() {
    ...
    const {allowSlideNext: s, allowSlidePrev: n, snapGrid: r} = i, l = i.virtual && i.params.virtual.enabled;
...
const ge = (i, e) => {
    const t = B(), {params: s, el: n, wrapperEl: r, device: l} = i, o = !!s.nested,
        a = e === "on" ? "addEventListener" : "removeEventListener", d = e;
    t[a]("touchstart", i.onDocumentTouchStart, {
        passive: !1,
        capture: o
    }), n[a]("touchstart", i.onTouchStart, {passive: !1}), n[a]("pointerdown", i.onTouchStart, {passive: !1}), t[a]("touchmove", i.onTouchMove, {
        passive: !1,
        capture: o
    }), t[a]("pointermove", i.onTouchMove, {
        passive: !1,
        capture: o
    }), t[a]("touchend", i.onTouchEnd, {passive: !0}), t[a]("pointerup", i.onTouchEnd, {passive: !0}), t[a]("pointercancel", i.onTouchEnd, {passive: !0}), t[a]("touchcancel", i.onTouchEnd, {passive: !0}), t[a]("pointerout", i.onTouchEnd, {passive: !0}), t[a]("pointerleave", i.onTouchEnd, {passive: !0}), t[a]("contextmenu", i.onTouchEnd, {passive: !0}), (s.preventClicks || s.preventClicksPropagation) && n[a]("click", i.onClick, !0), s.cssMode && r[a]("scroll", i.onScroll), s.updateOnWindowResize ? i[d](l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", he, !0) : i[d]("observerUpdate", he, !0), n[a]("load", i.onLoad, {capture: !0})
};

function kt() {
    const i = this, {params: e} = i;
    i.onTouchStart = It.bind(i), i.onTouchMove = Ct.bind(i), i.onTouchEnd = Lt.bind(i), i.onDocumentTouchStart = Gt.bind(i), e.cssMode && (i.onScroll = At.bind(i)), i.onClick = zt.bind(i), i.onLoad = Ot.bind(i), ge(i, "on")
}
...
function Ft() {
    const i = this, {realIndex: e, initialized: t, params: s, el: n} = i, r = s.breakpoints;
    if (!r || r && Object.keys(r).length === 0) return;
    const l = i.getBreakpoint(r, i.params.breakpointsBase, i.el);
    if (!l || i.currentBreakpoint === l) return;
    const a = (l in r ? r[l] : void 0) || i.originalParams, d = ve(i, s), c = ve(i, a), u = s.enabled;
    d && !c ? (n.classList.remove(`${s.containerModifierClass}grid`, `${s.containerModifierClass}grid-column`), i.emitContainerClasses()) : !d && c && (n.classList.add(`${s.containerModifierClass}grid`), (a.grid.fill && a.grid.fill === "column" || !a.grid.fill && s.grid.fill === "column") && n.classList.add(`${s.containerModifierClass}grid-column`), i.emitContainerClasses()), ["navigation", "pagination", "scrollbar"].forEach(h => {
        ...
        const x = s[h] && s[h].enabled, g = a[h] && a[h].enabled;
        x && !g && i[h].disable(), !x && g && i[h].enable()
    });
    const p = a.direction && a.direction !== s.direction, f = s.loop && (a.slidesPerView !== s.slidesPerView || p),
        m = s.loop;
    ...
    }), u && !w ? i.disable() : !u && w && i.enable(), i.currentBreakpoint = l, i.emit("_beforeBreakpoint", a), t && (f ? (i.loopDestroy(), i.loopCreate(e), i.updateSlides()) : !m && T ? (i.loopCreate(e), i.updateSlides()) : m && !T && i.loopDestroy()), i.emit("breakpoint", a)
}

function Bt(i, e, t) {
    if (e === void 0 && (e = "window"), !i || e === "container" && !t) return;
    let s = !1;
    const n = z(), r = e === "window" ? n.innerHeight : t.clientHeight, l = Object.keys(i).map(o => {
...
function _t() {
    const i = this, {classNames: e, params: t, rtl: s, el: n, device: r} = i,
        l = $t(["initialized", t.direction, {"free-mode": i.params.freeMode && t.freeMode.enabled}, {autoheight: t.autoHeight}, {rtl: s}, {grid: t.grid && t.grid.rows > 1}, {"grid-column": t.grid && t.grid.rows > 1 && t.grid.fill === "column"}, {android: r.android}, {ios: r.ios}, {"css-mode": t.cssMode}, {centered: t.cssMode && t.centeredSlides}, {"watch-progress": t.watchSlidesProgress}], t.containerModifierClass);
...
function Yt(i, e) {
    return function (s) {
        ...
        typeof i[n] == "object" && !("enabled" in i[n]) && (i[n].enabled = !0), i[n] || (i[n] = {enabled: !1}), A(e, s)
    }
}
...
class G {
    constructor() {
        ...
        n.length === 1 && n[0].constructor && Object.prototype.toString.call(n[0]).slice(8, -1) === "Object" ? t = n[0] : [e, t] = n, t || (t = {}), t = A({}, t), e && !t.el && (t.el = e);
        const l = B();
        ...
        const o = this;
        o.__swiper__ = !0, o.support = ue(), o.device = Be({userAgent: t.userAgent}), o.browser = $e(), o.eventsListeners = {}, o.eventsAnyListeners = [], o.modules = [...o.__modules__], t.modules && Array.isArray(t.modules) && o.modules.push(...t.modules);
        const a = {};
        o.modules.forEach(c => {
            c({
                params: t,
        ...
        const d = A({}, we, a);
        return o.params = A({}, d, te, t), o.originalParams = A({}, o.params), o.passedParams = A({}, t), o.params && o.params.on && Object.keys(o.params.on).forEach(c => {
    ...
    getSlideIndex(e) {
        const {slidesEl: t, params: s} = this, n = O(t, `.${s.slideClass}, swiper-slide`), r = ce(n[0]);
        return ce(e) - r
    }
    ...
    setProgress(e, t) {
        ...
        s.translateTo(l, typeof t == "undefined" ? 0 : t), s.updateActiveIndex(), s.updateSlidesClasses()
    }
    ...
    slidesPerViewDynamic(e, t) {
        ...
        const s = this, {params: n, slides: r, slidesGrid: l, slidesSizesGrid: o, size: a, activeIndex: d} = s;
        let c = 1;
        if (typeof n.slidesPerView == "number") return n.slidesPerView;
        if (n.centeredSlides) {
            let u = r[d] ? r[d].swiperSlideSize : 0, p;
            for (let f = d + 1; f < r.length; f += 1) r[f] && !p && (u += r[f].swiperSlideSize, c += 1, u > a && (p = !0));
            for (let f = d - 1; f >= 0; f -= 1) r[f] && !p && (u += r[f].swiperSlideSize, c += 1, u > a && (p = !0))
        } else if (e === "current") for (let u = d + 1; u < r.length; u += 1) (t ? l[u] + o[u] - l[d] < a : l[u] - l[d] < a) && (c += 1); else for (let u = d - 1; u >= 0; u -= 1) l[d] - l[u] < a && (c += 1);
        return c
    }
    ...
    update() {
        ...
        let r;
        if (s.freeMode && s.freeMode.enabled && !s.cssMode) n(), s.autoHeight && e.updateAutoHeight(); else {
    ...
    mount(e) {
        ...
        return !l && t.params.createElements && (l = X("div", t.params.wrapperClass), s.append(l), O(s, `.${t.params.slideClass}`).forEach(o => {
            l.append(o)
        })), Object.assign(t, {
            el: s,
            wrapperEl: l,
    ...
    destroy(e, t) {
        ...
        const s = this, {params: n, el: r, wrapperEl: l, slides: o} = s;
        return typeof s.params == "undefined" || s.destroyed || (s.emit("beforeDestroy"), s.initialized = !1, s.detachEvents(), n.loop && s.loopDestroy(), t && (s.removeClasses(), r.removeAttribute("style"), l.removeAttribute("style"), o && o.length && o.forEach(a => {
...
function Xt(i) {
    ...
    const n = "[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]",
        r = (a, d) => {
            const {rtl: c} = e, u = c ? -1 : 1, p = a.getAttribute("data-swiper-parallax") || "0";
            let f = a.getAttribute("data-swiper-parallax-x"), m = a.getAttribute("data-swiper-parallax-y");
            const w = a.getAttribute("data-swiper-parallax-scale"), T = a.getAttribute("data-swiper-parallax-opacity"),
                h = a.getAttribute("data-swiper-parallax-rotate");
            if (f || m ? (f = f || "0", m = m || "0") : e.isHorizontal() ? (f = p, m = "0") : (m = p, f = "0"), f.indexOf("%") >= 0 ? f = `${parseInt(f, 10) * d * u}%` : f = `${f * d * u}px`, m.indexOf("%") >= 0 ? m = `${parseInt(m, 10) * d}%` : m = `${m * d}px`, typeof T != "undefined" && T !== null) {
                const g = T - (T - 1) * (1 - Math.abs(d));
                a.style.opacity = g
            }
            let x = `translate3d(${f}, ${m}, 0px)`;
            typeof w != "undefined" && w !== null && (x += ` scale(${w - (w - 1) * (1 - Math.abs(d))})`), h && typeof h != "undefined" && h !== null && (x += ` rotate(${h * d * -1}deg)`), a.style.transform = x
        }, l = () => {
            const {el: a, slides: d, progress: c, snapGrid: u, isElement: p} = e, f = O(a, n);
            e.isElement && f.push(...O(e.hostEl, n)), f.forEach(m => {
                r(m, c)
            }), d.forEach((m, w) => {
                let T = m.progress;
                e.params.slidesPerGroup > 1 && e.params.slidesPerView !== "auto" && (T += Math.ceil(w / 2) - c * (u.length - 1)), T = Math.min(Math.max(T, -1), 1), m.querySelectorAll(`${n}, [data-swiper-parallax-rotate]`).forEach(h => {
                    r(h, T)
                })
            })
        }, o = function (a) {
            a === void 0 && (a = e.params.speed);
            const {el: d, hostEl: c} = e, u = [...d.querySelectorAll(n)];
            e.isElement && u.push(...c.querySelectorAll(n)), u.forEach(p => {
